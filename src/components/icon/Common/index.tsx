    ...
    case 'CancelS':
      return (
        <Svg width={12} height={12} fill="none" {...props}>
          <Path stroke="#1D1F1F" strokeLinecap="round" d="m10 2-8 8M2 2l8 8" />
        </Svg>
      );
    case 'CancelR':
      return (
    ...
    case 'TextCancelR':
      return (
        <Svg width={16} height={16} fill="none" {...props}>
          ...
          <Path stroke="#fff" strokeLinecap="round" d="m11 5-6 6M5 5l6 6" />
        </Svg>
      );
    case 'LocationR':
      return (
    ...
    case 'NVBoxM':
      return (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
          <rect x="3" y="4" width="18" height="3.6" rx="0.9" fill="#BBC3C3" />
          <path
            fill-rule="evenodd"
            clip-rule="evenodd"
