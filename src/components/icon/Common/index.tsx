            ...
            return (
                <Svg width={32} height={32} fill="none" {...props}>
                    <Path
                        fill="#838A8A"
                        fillRule="evenodd"
                        d="M12.72 8.056c0-.405-.395-.734-.88-.734-.487 0-.881.329-.881.734v.868h1.76v-.868Zm-3.64.87c-1.062 0-1.922.86-1.922 1.92v1.298h17.684v-1.297c0-1.061-.86-1.922-1.921-1.922H9.079Zm15.762 5.011H7.158v9.138c0 1.061.86 1.921 1.921 1.921h13.842c1.06 0 1.92-.86 1.92-1.92v-9.139ZM20.16 7.322c.486 0 .88.329.88.734v.868h-1.76v-.868c0-.405.394-.734.88-.734Zm-8.283 12.07a.84.84 0 0 1 .84-.84h2.443v-2.443a.84.84 0 0 1 1.678 0v2.443h2.443a.84.84 0 1 1 0 1.678H16.84v2.443a.84.84 0 1 1-1.678 0v-2.442h-2.443a.84.84 0 0 1-.84-.84Z"
                        clipRule="evenodd"
                    />
                </Svg>
            );
